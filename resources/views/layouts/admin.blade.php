        ...
        <div id="sidebar" class="z-50 bg-white w-64 absolute inset-y-0 left-0 transform -translate-x-full transition duration-200 ease-in-out md:relative md:translate-x-0">
            ...
            <nav class="p-4 text-rojo overflow-y-auto h-menu" x-data="{openRoles:true, openServicios:true}">
                ...
                @can('Lista de trámites')
                    ...
                    <a href="{{ route('tramites') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de dependencias')
                    ...
                    <a href="{{ route('dependencias') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de notarias')

                    <a href="{{ route('notarias') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Lista de entradas')
                    ...
                    <a href="{{ route('entrada') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Recepción')
                    ...
                    <a href="{{ route('recepcion') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Entrega')
                    ...
                    <a href="{{ route('entrega') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
                ...
                @can('Consultas')
                    ...
                    <a href="{{ route('consulta') }}" class="mb-3 capitalize font-medium text-md hover:text-red-600 transition ease-in-out duration-500 flex hover  hover:bg-gray-100 p-2 px-4 rounded-xl">
