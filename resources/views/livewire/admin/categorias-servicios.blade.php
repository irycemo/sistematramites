    ...
    <div class="mb-5">
        ...
        <div class="flex justify-between">
            ...
            @can('Crear usuario')
                ...
                <button wire:click="abrirModalCrear" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right items-center mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    @can('Editar usuario')
                                        ...
                                        <button
                                            ...
                                            class="bg-blue-400 hover:shadow-lg text-white text-xs md:text-sm px-3 py-2 rounded-full mr-2 hover:bg-blue-700 flex items-center focus:outline-none"
                                        >
