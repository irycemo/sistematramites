<div class="">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Notarías</h1>
            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('notario')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
                        ...
                        <th wire:click="order('rfc')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
                    ...
                    @foreach($notarias as $notario)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($notario->creadoPor != null)

                                    <span class="font-semibold">Registrado por: {{$notario->creadoPor->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($notario->actualizadoPor != null)

                                    <span class="font-semibold">Actualizado por: {{$notario->actualizadoPor->name}}</span> <br>
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    @can('Editar notaria')
                                        ...
                                        <button
                                            ...
                                            wire:target="abiriModalEditar({{$notario->id}})"
                ...
                <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="number" class="bg-white rounded text-sm w-full" wire:model.defer="modelo_editar.numero">

                        </div>

                        <div>

                            @error('modelo_editar.numero') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="text" class="bg-white rounded text-sm w-full" wire:model.defer="modelo_editar.notario">

                        </div>

                        <div>

                            @error('modelo_editar.notario') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
                ...
                <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                    ...
                    <div class="flex-auto ">
                        ...
                        <div>
                            ...
                            <input type="text" class="bg-white rounded text-sm w-full" wire:model.defer="modelo_editar.rfc">

                        </div>

                        <div>

                            @error('modelo_editar.rfc') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
    ...
    <x-jet-confirmation-modal wire:model="modalBorrar">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar la notaría? No sera posible recuperar la información.
        </x-slot>
